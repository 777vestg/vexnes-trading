...
const mainPage = {
  pageTitle: "vExnes Trading",
  firstBlock: {
    title: ' BIGGER MARKET <span class="goldText">BIG</span> OPPORTUNITIES ',
    bannerCard: {
      title: "Better conditions",
      description:
        "VEX provides access to the world's largest financial markets, through implementation of innovative technological solutions ",
      buttonText: "More",
      buttonLink: "https://trade.vesta-tg.com/registration-en",
    },
    bannerNote: "Invest in the most high-yield market at vExnes Trading",
  },
  assetsBlock: {
    assetsNumber: "17000",
    assetsText: "ASSETS",
  ...
  differenceBlock: {
    title:
      'What makes <span class="goldText">vExnes Trading?</span> different?',
    differenceList: [
      {
  ...
  trustBlock: {
    ...
    description:
      "vExnes Trading has been providing its services since 2013 and since then our high reliability is reflected in outstanding performance every year",
    trustList: [
...
const companyPage = {
  ...
  firstBlock: {
    ...
    bannerCard: {
      description:
        "vExnes Trading was founded in 2013 by a group of leading financial market experts to provide its clients with independent trading opportunities.",
    },
  },
  assetsBlock: {
  ...
  chooseBlock: {
    title: 'What makes <span class="goldText">vExnes Trading different</span>',
    chooseBlockList: [
      {
        title: "Precise data",
